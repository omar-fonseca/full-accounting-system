...
const DashboardOverview = ({ summary, loading, error, onRetry }) => {
  ...
  <section className="dashboard-page-intro"><div><span className="dashboard-eyebrow">Corte operativo · Datos de demostración</span><h1>Visión de la estación</h1><p>Una lectura rápida de la operación para decidir dónde actuar primero.</p></div><button type="button" className="dashboard-refresh-button" onClick={onRetry}><DashboardIcon name="RefreshCw" size={16} /> Actualizar vista</button></section>
